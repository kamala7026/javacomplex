			...
			<div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"><h3 class="panel-title">Print Details</h3></div>
                            <div class="panel-body">
                                <div class=" form">
					
							
							 <form:form class="cmxform form-horizontal tasi-form" id="printCustomerDetails" method="POST"  modelAttribute="printC
                                  ustomerDetails" action="printCustomerDetails.htm" novalidate="novalidate" target="_blank">
                                 <div class="form-group ">
                                         ...
                                         <input type="hidden" class="form-control " id="customerId" name="customerId" type="text" value="<%=request.getParameter("customerId") %>" path="customerId">
