			...
			<div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"><h3 class="panel-title">Update Contact</h3></div>
							...
							<form:form class="cmxform form-horizontal tasi-form" id="addCustomer" method="POST"  modelAttribute="customer" action="update_customer.htm" novalidate="novalidate">
                						<input type="hidden" name="customerId" value="${customer.customerId}">
                                        <div class="form-group ">
                                            <label for="firstname" class="control-label col-lg-2">Name *</label>
                                            <div class="col-lg-10">
                                                <input class=" form-control" id="name" name="name" path="name" type="text" value="${customer.name}">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="lastname" class="control-label col-lg-2">Godown Number  *</label>
                                            <div class="col-lg-10">
                                                <input class=" form-control" id="gnumber" name="godownNo" path="godownNo" type="text" value="${customer.godownNo}">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="username" class="control-label col-lg-2">Mobile *</label>
                                            <div class="col-lg-10">
                                                <input class="form-control numeric" id="mobile" name="mobile" path="mobile" type="text" value="${customer.mobile}" onkeypress="return numeric(event)">
                                            </div>
                                        </div>
                                       <div class="form-group ">
                                            <label for="email" class="control-label col-lg-2">Email </label>
                                            <div class="col-lg-10">
                                                <input class="form-control " id="email" name="email" type="email" path="email" value="${customer.email}">
                                            </div>
                                        </div>
                                          <div class="form-group ">
                                            <label for="email" class="control-label col-lg-2">Date Of Birth</label>
                                            <div class="col-lg-10">
                                                <input class="form-control " id="dob" name="dob"  path="dob" value="${customer.dob}">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="email" class="control-label col-lg-2">Address </label>
                                            <div class="col-lg-10">
                                                <input class="form-control " id="address" name="address" type="text" path="address" value="${customer.address}"> 
                                            </div>
                                        </div>
                                         <div class="form-group ">
                                            <label for="username" class="control-label col-lg-2">State </label>
                                            <div class="col-lg-10">
                                                <input class="form-control " id="state" name="state" path="state" value="${customer.state}" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                            <label for="username" class="control-label col-lg-2">City </label>
                                            <div class="col-lg-10">
                                                <input class="form-control " id="city" name="city" path="city" type="text"  value="${customer.city}">
                                            </div>
                                        </div>
                                          <div class="form-group ">
                                            <label for="username" class="control-label col-lg-2">Land line </label>
                                            <div class="col-lg-10">
                                                <input class="form-control " id="landline" name="landline" path="landline" type="text" onkeypress="return numeric(event)" value="${customer.landline}">
                                            </div>
                                        </div>
                                          <div class="form-group ">
                                            <label for="username" class="control-label col-lg-2">Secondary phone </label>
                                            <div class="col-lg-10">
                                                <input class="form-control " id="sphone" name="sphone" path="sphone" type="text" onkeypress="return numeric(event)" value="${customer.sphone}">
                                            </div>
                                        </div>
                                        <div class="form-group">
