                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
							...
							<c:if test="${null != status && searchHappen=='true' && productDetails!=null}">
								<%
                            ...
                            <c:choose>
				              <c:when test="${productDetails!=null}">
                                ...
                                <div class="row">
									...
									<td>${stockdetails.productLocation}</td>
									<td>${stockdetails.productExtraInfo}</td>
									</tr>
										</c:forEach>
										</tbody>
                                            </table>
		    ...
		    for (i = 0; i < rows.length; i++) {
		        rows[i].onclick = function(){ return function(){
		               ...
		               if(productId != 'Product Id'){
		            	   Stock.fetchProductDetails(productId);
		               }
