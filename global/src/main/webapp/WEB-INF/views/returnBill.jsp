...
<head>
       ...
       -->
        ...
        <script src="<c:url value="/resources/theme/functionality/return_bill.js"/>"></script>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">Return Bill</h3>
							 ...
							 <div class="form-group" style="margin-top: 1%; margin-bottom: 0px;">
                                <div class="form-group" style="width: 50%;overflow: hidden;float: left;">
										 ...
										 <span id="cloneRow" style="margin-right :5px">Add Row</span> 
										  <span id="generateBill" class="fa fa-rocket" style="margin-right :5px">Generate Return Bill</span> 
